...
| **M3** | Acceptance | Claude | typecheck ✓ · `npm test` green (+D12) · conformance 9/9 · vectors stay 5 · Brain imports no spine/keys (seam) · frozen agent contracts intact · NOTES reviewed | ☐ |
